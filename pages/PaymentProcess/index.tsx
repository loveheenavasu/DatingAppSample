        ...
        <View style={[style.backContainer, style.extraStyle]}>
          <ScrollView horizontal={true}>
            <TouchableOpacity style={style.leftContainer} onPress={goToNewCard}>
              <FastImage source={add} style={style.logoImage} />
              <MaterialIcon
                name="plus"
                size={30}
                color={theme.cardTextColor}
                style={style.nexStyle}
              />
            </TouchableOpacity>
            <View style={[style.rightContainer, style.extraContainer]}>
              <FastImage source={card} style={style.styleImage} />
            </View>
            <View style={[style.rightContainer, style.extraContainer]}>
              <FastImage source={card} style={style.styleImage} />
            </View>
      ...
      <ScrollView>
        <TouchableOpacity style={style.backContainer}>
          ...
          <View style={style.rightContainer}>
            <ThemedText
              styleKey="textColor"
              style={[style.textStyle, style.contentText]}
            >
              Credit/Debit Card
            </ThemedText>
          </View>
        ...
        <TouchableOpacity style={style.backContainer}>
          ...
          <View style={style.rightContainer}>
            <ThemedText
              styleKey="textColor"
              style={[style.textStyle, style.extraText]}
            >
              Google wallet
            </ThemedText>
          </View>
        ...
        <TouchableOpacity style={style.backContainer}>
          <View style={style.leftContainer}>
            <FastImage source={pay} style={style.newImage} />
          </View>
          <View style={style.rightContainer}>
            <ThemedText
              styleKey="textColor"
        ...
        <TouchableOpacity style={style.backContainer}>
          <View style={style.leftContainer}>
            <Icon
              ...
              size={30}
              color={theme.textColor}
              style={[style.backIcon, { marginLeft: 5 }]}
            />
          </View>
          <View style={style.rightContainer}>
            <ThemedText
