            ...
            renderCard={(card) => {
              return (
                <View style={style.card}>
                  <FastImage source={cardImage} style={style.imageCard} />
            ...
            <View style={style.bottomContent}>
              <View style={style.childContainer}>
                <View style={style.iconContainer}>
                  <TouchableOpacity>
                    <FastImage source={cross} style={style.logoImage} />
                  </TouchableOpacity>
                </View>
                <View style={style.iconContainer}>
                  <TouchableOpacity onPress={goToMatched}>
                    <FastImage source={chat} style={style.specialStyle} />
                  </TouchableOpacity>
                </View>
                <View style={style.iconContainer}>
                  <TouchableOpacity>
                    <FastImage source={heart} style={style.logoImage} />
                  </TouchableOpacity>
                </View>
              </View>
            </View>
