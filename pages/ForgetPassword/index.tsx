...
const ForgetPassword: React.FunctionComponent<Props> = ({ history }: Props) => {
      ...
      <View style={style.mainContainer}>
        <FastImage source={ImagePath} style={style.imageStyle}>
          ...
          <View style={[style.topContainer, style.nexStyle]}>
            ...
            >
              {constants.forgetText}
            </ThemedText>
          </View>
          <RoundButton
            buttonStyle={style.inputLabel}
            label={constants.choiceOne}
            buttonColor={theme.forgetColor}
            labelStyle={theme.highlightTextColor}
          />
          <RoundButton
            buttonStyle={[style.inputLabel, style.title]}
            label={constants.resetPass}
            buttonColor={theme.backgroundColor}
            labelStyle={theme.appColor}
          />
