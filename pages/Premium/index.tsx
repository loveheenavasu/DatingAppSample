      ...
      <View style={style.mainContainer}>
        <FastImage source={ImagePath} style={style.imageStyle}>
          ...
          <View style={[style.topContainer, style.extraStyle]}>
            ...
            >
              <FastImage source={forget} style={style.logoImage} />
            </View>
          </View>
          ...
          <View style={[style.extraStyle, style.title]}>
            <View style={style.childContainer}>
              <View style={style.listContainer}>
                <View
                  style={[style.listStyle, { backgroundColor: theme.appColor }]}
                >
                  <ThemedText styleKey="appColor" style={style.Icon}>
                    {"\u2022" + " "}
                  </ThemedText>
                </View>
                <View style={style.bottomContent}>
                  <ThemedText styleKey="premiumColor" style={style.iconStyle}>
                    Unlimted Swipes
                  </ThemedText>
                </View>
              </View>
          ...
          <TouchableOpacity onPress={goToPaymentProcess}>
            ...
            >
              <View style={style.iconContainer}>
                ...
                >
                  {constants.activatePremium}
                </ThemedText>
                <ThemedText
                  styleKey="textColor"
                  style={[style.textStyle, { color: theme.highlightTextColor }]}
                >
                  {constants.perMonth}
                </ThemedText>
              </View>
