...
const Matched: React.FunctionComponent<Props> = ({ history }: Props) => {
    ...
    <View style={style.mainContainer}>
      <ScrollView>
        <FastImage source={ImagePath} style={style.imageStyle}>
            ...
            <View style={style.bottomContent}>
              <View style={style.childContainer}>
                ...
                <View style={[style.iconContainer, style.rightMatchContainer]}>
                  <FastImage source={boy} style={style.logoImage} />
                </View>
              </View>
            </View>
          </View>
          <View style={style.childContainer}>
            <ThemedText
              style={[style.forgotPassword, style.messageContent]}
              styleKey="highlightTextColor"
            >
              {constants.matchText}
            </ThemedText>
